...
void VulkanDescriptor::create_pool_and_layout(
    ...
    if (can_free) // Allows explicit call of free commands on descriptors from this pool
...
VulkanBuffer* VulkanDescriptor::get_buffer(const uint32 binding, const uint32 index) const {

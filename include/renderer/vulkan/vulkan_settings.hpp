...
class VulkanSettings {
  public:
    ...
    // Debugger
    constexpr static vk::DebugUtilsMessageSeverityFlagsEXT
        enabled_message_security_levels =
    ...
    // Swapchain
    constexpr static auto preferred_swapchain_format =
        vk::Format::eB8G8R8A8Srgb;
    constexpr static auto preferred_swapchain_color_space =
        vk::ColorSpaceKHR::eSrgbNonlinear;
    constexpr static auto preferred_swapchain_presentation_mode =
